class Users::RegistrationsController < Devise::RegistrationsController
    ...
    if signed_in?
      ...
      respond_to do |format|
        if @user.save
          ...
          format.html { redirect_to  user_show_path(@user), notice: 'El usuario se ha creado exitosamente.' }
  ...
  private
    def set_roles
      ...
      if @roles.blank?
        redirect_to new_role_path, alert: 'No existen roles para Administradores de Empresa' and return
      end
    end
end
